...
def calculate_frequency(letters_dict):
    """Функция по поиску частоты букв из их числа в тексте"""
    letters_sum = sum(letters_dict.values())
    frequency = dict()
    for letter, count in letters_dict.items():
        frequency[letter] = count / letters_sum
    return frequency
...
for item, value in calculate_frequency(count_letters(main_str)).items():
